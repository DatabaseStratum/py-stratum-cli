...
class DataLayer(StaticDataLayer):
    ...
    # ------------------------------------------------------------------------------------------------------------------
    @staticmethod
    def dbo_tst_test_rows_with_key1(p_count):
        ret = {}
